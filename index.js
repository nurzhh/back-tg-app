...
bot.onText(/\/start/, async (msg) => {
    ...
    await bot.sendMessage(
        ...
        {
            reply_markup: {
                keyboard: [[{text: "Пройти тест", web_app: {url: `${WEB_APP_URL}`}}]],
